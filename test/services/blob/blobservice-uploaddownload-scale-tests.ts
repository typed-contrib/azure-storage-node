...
var blobService: azure.BlobService = null;
    ...
    function getTestFunction(api, size) {
      return function(done) {
        ...
        generateTempFile(name, size, function(error, fileInfo) {
          ...
          var uploadOptions = { storeBlobContentMD5: true, parallelOperationThreadCount: 5 } as azure.BlobService.UploadBlobOptions;
